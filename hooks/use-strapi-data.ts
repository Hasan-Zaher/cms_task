  ...
  useEffect(() => {
    async function fetchTeamMembers() {
      try {
        ...
        console.warn(
          "Failed to fetch team members from Strapi, using fallback data"
        );
  ...
  useEffect(() => {
    async function fetchServices() {
      try {
        ...
        console.warn(
          "Failed to fetch services from Strapi, using fallback data"
        );
  ...
  useEffect(() => {
    async function fetchTestimonials() {
      try {
        ...
        console.warn(
          "Failed to fetch testimonials from Strapi, using fallback data"
        );
  ...
  useEffect(() => {
    async function fetchHeroSlides() {
      try {
        ...
        console.warn(
          "Failed to fetch hero slides from Strapi, using fallback data"
        );
