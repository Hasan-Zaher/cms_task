...
import type { TeamMember, Service, Testimonial, HeroSlide, BlogPost } from "./strapi"
...
export const fallbackTeamMembers: TeamMember[] = [
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-1fJHzVzxr6lOSSGm4PKqdHlq34EL4P.png",
...
export const fallbackTestimonials: Testimonial[] = [
  {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-E17mkYc9ZHJXzJtpN7BVkyApQWFr70.png",
    rating: 5,
  },
  {
    id: 2,
...
export const fallbackHeroSlides: HeroSlide[] = [
  {
    ...
    description: "Comprehensive legal solutions with expertise and dedication to serve our clients' needs effectively",
...
export const fallbackBlogPosts: BlogPost[] = [
  {
    ...
    excerpt: "A comprehensive guide to the latest developments in corporate law and their implications for businesses.",
  ...
  },
  {
    ...
    excerpt: "Exploring the legal framework for foreign investment and the opportunities it presents.",
